...
def run_recursion(screen, clock, bg_image, back_img_original, settings):
    """Run the recursion activity"""
    # Create back button
    ...
    while running:
        ...
        title_text = font.render('Recursion', True, (255, 255, 255))
        screen.blit(title_text, (int(500 * scale), int(50 * scale)))
