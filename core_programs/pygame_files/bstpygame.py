...
def run_bst(screen, clock, bg_image, back_img_original, settings):
    """Run the binary search tree activity"""
    # Create back button
    ...
    while running:
        ...
        title_text = font.render('Binary Search Tree', True, (255, 255, 255))
        screen.blit(title_text, (int(420 * scale), int(50 * scale)))
