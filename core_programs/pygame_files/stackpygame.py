...
def run_stack(screen, clock, bg_image, back_img_original, settings):
    """Run the stack activity"""
    # Create back button
    ...
    while running:
        ...
        title_text = font.render('Stack - Parking Garage', True, (255, 255, 255))
        screen.blit(title_text, (int(400 * scale), int(50 * scale)))
